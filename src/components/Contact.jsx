    ...
    <section id="contact" className="fade-in" ref={ref}>
      <div className="container">
        ...
        <div className="contact-links">
          <a href="mailto:kaan.oguzkan@ug.bilkent.edu.tr" className="contact-item" aria-label="Email">
          ...
          <a href="https://github.com/kaanoguzkan" className="contact-item" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
          ...
          <a href="https://linkedin.com/in/kaan-oguzkan" className="contact-item" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
