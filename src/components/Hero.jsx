...
function Hero() {
  ...
  const typed = useTypingEffect(Array.isArray(phrases) ? phrases : []);
  ...
  return (
    <section id="hero">
      <ParticleBackground />
      <div className="hero-content" style={{ transform: `translateY(${offset}px)` }}>
        <h1 className="hero-name-gradient">{t('hero.name')}</h1>
